        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-ftg-green/20 rounded-full flex items-center justify-center text-ftg-green hover:bg-ftg-green hover:text-white transition-colors">
