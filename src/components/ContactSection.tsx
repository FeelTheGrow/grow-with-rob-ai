    ...
    <section id="contact" className="py-20 px-6 bg-gray-50">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-lg border border-gray-100">
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-ftg-green/10 rounded-full flex items-center justify-center text-ftg-green hover:bg-ftg-green hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016c.11-.016.025-.025.025-.025v-1.025h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
                  </svg>
                </a>
                <a href="#" className="w-10 h-10 bg-ftg-green/10 rounded-full flex items-center justify-center text-ftg-green hover:bg-ftg-green hover:text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className="md:col-span-3 bg-white p-6 rounded-lg shadow-lg border border-gray-100">
            <h3 className="text-2xl font-bold mb-6">
              Send Me a Message
            </h3>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid sm:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-ftg-green/50"
              ...
              <button 
                type="submit" 
                className={cn(
                  "fun-button w-full relative overflow-hidden",
