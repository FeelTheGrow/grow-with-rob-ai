...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, icon, delay }) => {
  ...
  return (
    <div 
      className={cn(
        "bg-white p-6 rounded-lg shadow-lg border-l-4 border-ftg-green card-hover",
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <ServiceCard 
            ...
            description="Shaping your product direction with customer-centric approaches and market insights that create sustainable value."
            icon={
          ...
          <ServiceCard 
            ...
            description="Creating partnerships and opportunities that unlock new markets and drive revenue growth."
            icon={
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <ServiceCard 
            ...
            description="Developing innovative marketing approaches that capture attention and convert prospects into loyal customers."
            icon={
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <ServiceCard 
            title="Growth Processes" 
            description="Implementing scalable systems and processes that support sustainable business growth and evolution."
            icon={
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <ServiceCard 
            ...
            description="Using data analysis to guide strategic choices, identifying opportunities and minimizing risks."
            icon={
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <ServiceCard 
            ...
            description="Determining when to persevere with current strategies and when to pivot for maximized success."
            icon={
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
