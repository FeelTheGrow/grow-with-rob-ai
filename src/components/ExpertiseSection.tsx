...
const ExpertiseArea: React.FC<ExpertiseAreaProps> = ({ title, description, active, onClick, icon }) => {
  return (
    <div 
      className={cn(
        "p-5 rounded-lg cursor-pointer transition-all duration-300",
        active 
          ? "bg-ftg-green text-white shadow-xl shadow-ftg-green/20" 
          : "bg-white hover:bg-ftg-light border border-gray-200"
      )}
      onClick={onClick}
    >
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className={cn(
            ...
            active ? "text-white/90" : "text-ftg-dark/70"
          )}>
            {description}
          </p>
        </div>
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative p-6 hidden md:block">
            ...
            <div className="relative bg-white p-8 rounded-lg shadow-xl border border-ftg-green/20">
